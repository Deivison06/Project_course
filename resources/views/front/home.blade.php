                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <h2>Com a metodologia e certificado da <a href="#"
                                                                target="_blank">Dev Treinamentos</a></h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center animate-box">
                    <p><a class="btn btn-primary btn-lg btn-learn" href="#">Garanta agora a sua vaga no Curso</a></p>
                </div>
            </div>
        </div>
    </div>
